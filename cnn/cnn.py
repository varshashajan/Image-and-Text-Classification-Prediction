...
image_dir=r'D:\3rd sem\deeplearning\Deep Learning Prediction\cnn\tumordata'
no_tumor_images=os.listdir(r'D:\3rd sem\deeplearning\Deep Learning Prediction\cnn\tumordata\no')
yes_tumor_images=os.listdir(r'D:\3rd sem\deeplearning\Deep Learning Prediction\cnn\tumordata\yes')
print("--------------------------------------\n")
...
history=cnn_model.fit(x_train,y_train,epochs=20,batch_size =128,validation_split=0.1)
...
cnn_model.save(r'D:\3rd sem\deeplearning\Deep Learning Prediction\CN.keras')
